...
const servicesData = [
  { type: 'platform', icon: Monitor, title: 'White-Label Trading Platforms', desc: 'Deploy industry-standard trading terminals with customized branding. We offer rapid integration of MT4 and MT5 infrastructure, allowing you to launch your brokerage with proven technology.', span: 'lg:col-span-2 md:col-span-2', bgStyle: 'bg-[#0f172a]/60 backdrop-blur-2xl border border-white/[0.05] hover:border-accent-cyan/40 hover:bg-[#0f172a]/90 hover:shadow-[0_0_30px_rgba(0,229,255,0.1)]' },
  { type: 'crm', icon: Users, title: 'Forex CRM & Back-Office', desc: 'Streamline your operations with our purpose-built CRM. Manage client onboarding, KYC/AML processes, IB structures, and multi-tier reporting from a single, secure dashboard.', span: 'lg:col-span-1 md:col-span-1', bgStyle: 'bg-gradient-to-br from-accent-cyan/5 to-[#0f172a]/60 backdrop-blur-2xl border border-accent-cyan/20 hover:border-accent-cyan/60 hover:bg-[#0f172a]/90 hover:shadow-[0_0_30px_rgba(0,229,255,0.15)]' },
  { type: 'liquidity', icon: LineChart, title: 'Liquidity Aggregation & Bridging', desc: 'Connect directly to Institutional liquidity providers. Our bridging solutions ensure optimized latency execution and deep liquidity access to support your institutional trading requirements.', span: 'lg:col-span-1 md:col-span-1', bgStyle: 'bg-[#0f172a]/60 backdrop-blur-2xl border border-white/[0.05] hover:border-accent-cyan/40 hover:bg-[#0f172a]/90 hover:shadow-[0_0_30px_rgba(0,229,255,0.1)]' },
  { type: 'compliance', icon: Server, title: 'Technology & Infrastructure Support', desc: 'Maintain maximum uptime with our dedicated technical support and secure cloud hosting environments, designed specifically for the rigorous demands of financial markets.', span: 'lg:col-span-2 md:col-span-2', bgStyle: 'bg-[#0f172a]/60 backdrop-blur-2xl border border-white/[0.05] hover:border-accent-cyan/40 hover:bg-[#0f172a]/90 hover:shadow-[0_0_30px_rgba(0,229,255,0.1)]' },
];
